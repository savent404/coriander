...
using Type = coriander::base::Type;
using coriander::base::make_tuple;

TEST(Type, foo) { EXPECT_EQ(1, 1); }

TEST(Type, basic) {
  using TypeId = coriander::base::TypeId;
  using TypeHelper = coriander::base::TypeHelper;
