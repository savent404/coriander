...
void board_parameter_default_value_setup(
  ...
  static const Property properties[] = {
      P{3, ID::MotorCtl_General_Mode_RT},
      ...
      P{0.2f, ID::MotorCtl_CurrCtl_PidP},
